...
%     Tr = -1/2 * det(((I - Gplus) / 2)^3 + exp(1i .* alpha) .* ((I + Gplus) / 2)^3) + ...
%         1 * det(((I - Gplus) / 2)^2 * ((I - Gminus) / 2) + exp(1i .* alpha) .* ((I + Gplus) / 2)^2 * ((I + Gminus) / 2) ) +  ...
%         1/2 * det(((I - Gplus) / 2) * ((I - Gminus) / 2) * ((I - Gplus) / 2) + exp(1i .* alpha) .* ((I + Gplus) / 2) * ((I + Gminus) / 2) * ((I + Gplus) / 2));        
